...
export function LiveChatToggle({ roomId, position = 'bottom-right' }: LiveChatToggleProps) {
  ...
  return (
    <>
      ...
      {/* Chat window */}
      <div 
        className={`fixed ${positionClasses[position]} z-40 w-[500px] h-[700px] bg-[#181828] rounded-lg shadow-2xl mb-20 mr-2 transition-all duration-300 ${
