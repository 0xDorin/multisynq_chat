...
export function LiveChatToggle({
  ...
  const connStat = useChatSessionStore(
    (s) => s.connectionStatus[roomId] ?? "idle"
  );
  ...
  return (
    <>
      ...
      <div
        ...
        } z-40 w-[500px] h-[700px] bg-[#181828] rounded-lg shadow-2xl mb-20 mr-2 transition-transform duration-300 ${
          isVisible
